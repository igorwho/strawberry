...
import (
	"github.com/igorwho/strawberry/chatservice/internal/infra/grpc/bp"
	"github.com/igorwho/strawberry/chatservice/internal/usecase/chatcompletionstream"
)

type ChatService struct {
	bp.UnimplementedChatServiceServer
...
func (c *ChatService) ChatStream(req *bp.ChatRequest, stream bp.ChatService_ChatStreamServer) error {
